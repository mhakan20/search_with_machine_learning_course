...
def create_query(user_query, click_prior_query, filters, sort="_score", sortDir="desc", size=10, source=None, synonyms=False):
    ...
    #condition on the field to match        
    match_field = 'name'
    if synonyms == True:
                        ...
                        "should": [  #
                            ...
                            },
                            {
                                "multi_match": {
                                    ...
                                    "fields": ["name^10", "name.hyphens^10", "name.synonyms^5", "shortDescription^5",
...
if __name__ == "__main__":
    ...
    general.add_argument('--synonyms',
                         help='Defines if the search is matched with the help of synonyms')
